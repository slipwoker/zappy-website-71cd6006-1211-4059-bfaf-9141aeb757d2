    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('required') && !value) {
                if (errorMessages[name] && errorMessages[name].required) {
                    showError(input, errorMessages[name].required);
                } else {
            ...
            if (value && name === 'name' && value.length < 2) {
                showError(input, errorMessages.name.minLength);
                return false;
            }
            
            if (value && name === 'message' && value.length < 10) {
                showError(input, errorMessages.message.minLength);
                return false;
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '71cd6006-1211-4059-bfaf-9141aeb757d2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '71cd6006-1211-4059-bfaf-9141aeb757d2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '71cd6006-1211-4059-bfaf-9141aeb757d2';
